const frenchMessages = {
  ...
  "philosophy.hand_made":
    "préparé le matin même à Montréal avec des ingrédients frais provenant de fournisseurs et producteurs locaux",
  ...
  "calendar.no_menu_employee":
    "Pas de menu assigné, vous pourrez bientôt commander votre repas personnalisé",
  "calendar.no_menu_admin":
    "Merci pour votre confiance, nous allons bientôt assigné un menu à votre commande.",
  ...
  "additional_items.beverages":
    "Une sélection de breuvages parmi ceux-ci: eau de source, eau pétillante San Pellegrino, soda San Pellegrino, Coca-Cola, Coca-Cola diète.",
  "additional_items.desserts":
    "Le dessert de la journée sélectioné par nos chefs parmi ceux-ci: biscuits, mini-tartes, mini-cupcakes, mini-beignets.",
  ...
  "order_summary.service_fee_hint":
    "Un frais de 5% est chargé sur toutes les transactions pour la commande en ligne, la personnalisation des repas et le support.",
  "order_summary.recurring_price_message":
    "Cette commande est un lunch récurrent faisant partie du service de cafétéria virtuelle FoodRelay pour votre entreprise. Pour toutes questions concernant les termes de paiement, merci de vous référez vous à l’entente signée à cet effet.",
